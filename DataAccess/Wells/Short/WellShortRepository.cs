...
{
    public class WellShortRepository : IWellShortRepository
    {
        private readonly Geolog.Contracts.ISprav _spravService;
        ...
        public WellShortRepository(UserCredentials userCredentials, Geolog.Contracts.ISprav spravService, IWellShortAdapter commonWellAdapter,
